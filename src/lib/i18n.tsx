...
export const translations: Translations = {
  ...
  discoveryScanExplain: {
    ru: 'Сканирование TCP-порта 22 по указанным IPv4-подсетям (до 1024 адресов за запуск). Уже известные IP пропускаются.',
    en: 'Scans TCP port 22 on listed IPv4 subnets (up to 1024 addresses per run). Known IPs are skipped.',
  },
