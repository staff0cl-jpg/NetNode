...
export const translations: Translations = {
  ...
  topologyCanvasHint: {
    ru: 'Авторазметка активной вкладки строит слои Gateway/Core/Distribution/Access, группирует узлы вокруг Core и выносит unknown/orphan отдельно. Ручное перетаскивание сохраняется.',
    en: 'Auto layout for the active tab builds Gateway/Core/Distribution/Access layers, groups nodes around each core, and isolates unknown/orphan devices. Manual drag positions stay persisted.',
  },
  ...
  automationBatchSize: { ru: 'Batch size', en: 'Batch size' },
  automationTimeoutMs: { ru: 'Timeout (ms)', en: 'Timeout (ms)' },
  automationRetry: { ru: 'Retry', en: 'Retry' },
  automationConcurrency: { ru: 'Concurrency', en: 'Concurrency' },
  automationErrorThreshold: { ru: 'Error threshold', en: 'Error threshold' },
  automationDefaultsTitle: { ru: 'Automation defaults', en: 'Automation defaults' },
