...
export const translations: Translations = {
  ...
  opId: { ru: 'ID Оператора', en: 'Operator ID' },
  accToken: { ru: 'Токен доступа', en: 'Access Token' },
  ...
  serviceAccount: { ru: 'Service Account DN', en: 'Service Account DN' },
  accessGroup: { ru: 'Группы доступа (NetAdmins)', en: 'Access Group DN' },
