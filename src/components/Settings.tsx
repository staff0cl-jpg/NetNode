...
const Settings: React.FC = () => {
  ...
  return (
    <div className="p-8 space-y-8 max-w-4xl animate-in slide-in-from-bottom-5 duration-700">
      <header>
        <h2 className="text-2xl font-bold text-white mb-2 leading-tight">System Configuration</h2>
        <p className="text-sm text-[#909296]">Manage infrastructure settings, access control, and resource allocation.</p>
      </header>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#25262b] border border-[#373a40] rounded overflow-hidden">
          <div className="p-4 border-b border-[#373a40] bg-[#1c1d21] flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-bold text-white uppercase tracking-widest">Active Directory / LDAP Authentication</h3>
            </div>
            {testStatus !== 'idle' && (
              <div className={`text-[10px] font-bold uppercase py-1 px-3 rounded ${
                ...
                {testStatus === 'testing' ? 'Connecting...' : 
                 testStatus === 'success' ? '✓ Connection Succesful' : 
                 '✗ Connection Failed'}
              </div>
            )}
          </div>
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-[#909296] uppercase tracking-wider">LDAP Domain Controller</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-[#909296] uppercase tracking-wider">LDAP Port</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-[#909296] uppercase tracking-wider">Base DN</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-[#909296] uppercase tracking-wider">Service Account DN</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-[#909296] uppercase tracking-wider">Access Group DN (Security Filtering)</label>
        ...
        <div className="bg-[#25262b] border border-[#373a40] rounded overflow-hidden">
          <div className="p-4 border-b border-[#373a40] bg-[#1c1d21] flex items-center gap-3">
            ...
            <h3 className="text-sm font-bold text-white uppercase tracking-widest">Resource Planning & Sizing</h3>
          </div>
          <div className="p-6">
